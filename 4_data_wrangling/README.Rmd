...
For this weeks data practical, 

<!-- load three data sets into an R Markdown notebook and describe some of their variables in terms of the data types used in R and data types in terms of statistical data types. -->
