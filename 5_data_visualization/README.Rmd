...
Visualizing data can be time consuming for various reasons, but first and foremost it often requires that you first clean and wrangle your data into a format that the visualization library or functions can work with as input. Then of course, there can be lots of tweaking to get your visualizations to look nice. This can be for various reasons and there's tons of literature on visualization types, best practices, etc. Consider for example what you are trying to visualize. What kind of (statistical) data types? Are you trying to visualize -- or model -- a [statistical distribution](https://en.wikipedia.org/wiki/Probability_distribution)? How many variables are there? What are your independent and dependent variables? Do you have any? Do you have a hypothesis?
