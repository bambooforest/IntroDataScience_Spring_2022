...
Now create a folder in your repository for your first "scientific" report. You should create the .Rmd file and edit it in RStudio and then knit the output file into an .md file. You can write a bit about some topic that you are interested in. And use the R Markdown syntax to do things like:
...
Have fun and try to make the report interesting for the reader! It doesn't need to be a "real" scientific report with analyses and results (doesn't hurt if it though). The learning objective is that you get familiar and comfortable creating these short data practicals, so that in the follow lectures when we begin learning or reviewing various methods in data science, that you have the basis to implement those methods with real data of your choosing into R Markdown reports. That is, this lecture is about learning the basis on which you can start to do reproducible data science.
