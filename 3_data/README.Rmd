...
For this week's data practical, load three data sets into an R Markdown notebook and describe their variables in terms of the data types used in R and data types in terms of statistical data types. 

First, load one of [R's pre-loaded data](http://www.sthda.com/english/wiki/r-built-in-data-sets) (hint use the `data()` command in RStudio to have a look at what's available). There's a description of the data -- summarize it. What kind of R data types are there? If you prefer, you can also use a data set from this R library [@IrizarryGill2021]:
